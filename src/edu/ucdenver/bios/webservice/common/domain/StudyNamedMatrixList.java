 ...
 */
public class StudyNamedMatrixList {
     ...
     *            the uuid
     */
    public StudyNamedMatrixList(final byte[] uuid) {
        this.uuid = uuid;
    }
     ...
     *            the list
     */
    public StudyNamedMatrixList(final byte[] uuid, final List<NamedMatrix> list) {
        this.uuid = uuid;
     ...
     *            the size
     */
    public StudyNamedMatrixList(final int size) {
     ...
     *            the list
     */
    public StudyNamedMatrixList(final List<NamedMatrix> list) {
        this.matrixList = list;
    }
